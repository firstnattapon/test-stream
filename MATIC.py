...
class Run_model :
    def __init__(self , ex='deribit'):
        self.ex = ex
        self.pair_data = "MATIC-PERP"
        self.pair_trade = 'MATIC-PERPETUAL'
        self.apiKey ="AtdG0K3k"
        self.secret ="lItUXWckP2PNN-uPnrP_h_0dsctCXdFVP9x73bwo3Nc"
        self.swish  = lambda  x : s.expit(x)*x
        self.W_111 =    0.4317418
        self.W_112 =   -0.17524958
        self.B_111 =   -0.16386631
        
        self.W_121 =   -0.41327423
        self.W_122 =    0.2931837
        self.B_121 =    0.29502958
        
        self.W_131 =   0.4542866
        self.W_132 =  -0.16661477
        self.B_131 =  -0.15771855
        
        self.W_211 =  -0.37767223
        self.W_212 =   0.3551526
        self.W_213 =  -0.39447024
        self.B_211 =   0.17099084
        
        self.W_221 =  -0.33722228
        self.W_222 =   0.40579438
        self.W_223 =  -0.34851268
        self.B_221 =   0.15585908
        
        self.W_311 =   0.55559224
        self.W_312 =   1.0644473
        self.B_311 =   0.13381708
...
st.text("")
st.write('\n\nhttps://github.com/firstnattapon/test-stream/edit/master/MATIC.py')
