...
pyplot = model.chart
st.sidebar.text('Predict:' , model.deep.Predict[-1])
st.sidebar.text('Nav:', round(model.nav.Cumulative_Strategy_Returns[-2] , 2 ))
...
if st.sidebar.button('Refresh'):
    ...
    st.write(round(model.nav.Cumulative_Strategy_Returns[-2] , 2 ))
